module github.com/Gouplook/rpcxB

go 1.18

require (
	github.com/Gouplook/rpcxinterfaxe v0.0.0-20220418063522-a4cc51737ac7
...
replace github.com/Gouplook/rpcxinterfaxe => ./rpcxinterfaxe
